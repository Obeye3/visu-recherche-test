...
afficher_noeud_isole= False


dico = filtered_data(dico,None,["2020","2021"],None) # on prend les articles de 2020
#rint(dico)
...
def create_gephi_graph_bert(seui, auteur_dict: dict, keywords_dict: dict,auteurs_cible: list, keywords_cible: list, file_name: str):
    G = nx.Graph()
    #print(auteur_dict)
    # Ajoute toutes les arêtes
      # 1. Extraire les titres
